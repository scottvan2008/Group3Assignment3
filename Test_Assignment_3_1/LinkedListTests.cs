...
namespace Test_Assignment_3
{
    public class LinkedListTests
    {
        ...
        public void TestFindNode()
        {
             ...
             * a -> b -> c -> d
             */
            //First, check if the list contains "b",then,get the index of "b",Finaly, try retrieve function
        ...
        [Test]
        public void RemoveNodeSpecificIndex()
        {
			this.linkedList.Append("a");
			this.linkedList.Append("b");
			this.linkedList.Append("c");
			this.linkedList.Append("d");
            //test the delete function with the following element "c"
        ...
        public void getNumberOfItems()
        {
			...
			this.linkedList.Append("c");
			this.linkedList.Append("d");
            //test the size function with "4"
            int res = this.linkedList.Size();
		...
		public void TestReplaceTailNode()
		{
			...
			// Test the fourth node value is e
			Assert.AreEqual("e", this.linkedList.Retrieve(3));
		}
		...
		public void TestReplaceHeadNode()
		{
			...
			Assert.AreEqual("e", this.linkedList.Retrieve(0));
